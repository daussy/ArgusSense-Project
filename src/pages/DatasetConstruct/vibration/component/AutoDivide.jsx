...
// 方法
import {_vibautoDivide} from './functionList'
export default class AutoDivide extends Component{
    constructor(props){
        ...
        this.state ={
            ...
            trainingRatio:'',//训练比例
            trainingNum:'',//训练数量
            totalCount:store.getState().TagManagementreducer.vibTable.totalCount,
            testRatio:'',//测试比例
            testNum:'',//测试数量
            // TagNum:'',//有标签的图片数量
        }
...
onClose = ()=>{
   ...
   */
  handleSubmit = (values) => {
    _vibautoDivide(values.trainingNum)
    this.onClose()
  ...
  onChange=(changedValues, allValues)=>{
        ...
        let b = Math.ceil(allValues.trainingRatio*this.state.totalCount) 
        let c = this.state.totalCount-b
                ...
                <Space>
                   ...
                   <Form
                        ...
                        <Form.Item {...tailLayout}>
                            <Button className ="normalBtn" htmlType="submit" >确认划分</Button>
                        </Form.Item>
                        </Form>
